               ...
               {address.map((data,index)=>{
                ...
                return(
                  ...
                  <div className="interest__row__left grid grid-cols-2" >
                      ...
                      d.gender == 'Male'?   <Image src={photo_holder} />: <Image src={girlPhoto} /> 
                      }
                    </div>
                     
  <div className="interest__row__left__text">
  <Link href={`/viewProfile/${encodeURIComponent(data.id)}`}><h6>{d.brideName}</h6></Link>
      <p>{age_now} Yrs, {d.height} cm, {d.maritialStatus}</p>
      <p>{d.address}</p>
                  ...
                  >
                      ...
                      <Link href={`/viewProfile/${encodeURIComponent(data.id)}`}><button id='intr__acc__btn'>View Profile</button></Link>
