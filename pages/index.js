            ...
            >
               ...
               <div className='main__form__row grid md:grid-cols-2  gap-3 md:gap-10'>
                ...
                <div className='main__form__row__right'>
                    <p>Bride / Groom name<span style={{color:'red'}}>*</span></p>
                    <input
                    required
      ...
      />
            ...
            <div className='flex md:mt-4 main__form__gender'>
              ...
              <input
               ...
               <div className='main__form__check__div'>
                {/* <div className='flex'> */}
                  ...
                  id='main__form__checkbox' type='checkbox' checked={check}
                  onChange={()=>setCheck(!check)}
                  />
              <p> By clicking register free, you accept our T&C and Privacy Policy</p>
             ...
             {/* <Link href='/profilecreation/Basic'> */}
              <button disabled={!check} type='submit' id='home__main__form__btn'>Register Free</button>
